...
#    Updated: 2016/10/26 16:23:04 by syusof           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = fdf

SRCS = get_next_line.c ft_read_map.c ft_read_map1.c ft_read_map2.c mlx.c \
mlx2.c ft_init.c ft_checkmode.c ft_draw1.c ft_draw2.c

OFILES = get_next_line.o ft_read_map.o ft_read_map1.o ft_read_map2.o mlx.o \
